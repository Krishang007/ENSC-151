/******************************************************************
 * insertion.cpp  -- sorts an array of numbers using the insertion sort algorithm
 * Description:
 *    This program implements the insertion sort algorithm to sort an array of numbers
 *    in ascending order. The program prompts the user to enter the size of the array
 *    and the elements of the array. It then sorts the array using the insertion sort
...
void insertionSort(double sortedData[], int n);
...
int main()
{
    //vaiable declarations for the program 
    int n;            // number of elements
    double arr[SIZE]; // declare array
...
// insertion sort
/******************************************************************
 * insertionSort  -- sorts the array using insertion sort algorithm
...
void insertionSort(double sortedData[], int n)
{
    for (int i = 1; i < n; i++)
    {
        double currentValue = sortedData[i];
        int previousIndex = i - 1;

        // shift bigger elements one step right
        while (previousIndex >= 0 && sortedData[previousIndex] > currentValue)
        {
            sortedData[previousIndex + 1] = sortedData[previousIndex];
            previousIndex--;
        }

        // insert in correct place
        sortedData[previousIndex + 1] = currentValue;
    }
}
